...
import { CreateLoan, CreateReturn, getLoanData } from "../repositories/borrow";
...
export const returnLoan = async (req: Request<{},{},iNewBorrow>, res: Response) => {
    try {
        const { book_code, user_code } = req.body;
        ...
        const result = await CreateReturn(user_code, book_code);
